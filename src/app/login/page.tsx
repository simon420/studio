    ...
    <div className="login-page-container p-4">
      <div className="login-page-content-grid grid md:grid-cols-2 gap-x-12 gap-y-8 max-w-5xl w-full items-center">
        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left">
          <header className="max-w-md p-6 md:p-8 rounded-xl bg-card/80 backdrop-blur-md shadow-2xl"> {/* Added glassmorphism */}
            ...
            <p className="text-lg lg:text-xl text-card-foreground/90"> {/* Adjusted opacity for readability */}
        ...
        <div className="flex items-center justify-center w-full">
          <Card className="w-full max-w-md shadow-2xl bg-card/80 backdrop-blur-md rounded-xl"> {/* Added glassmorphism */}
            <CardHeader className="text-center">
              <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-primary/20 text-primary"> {/* Adjusted opacity */}
                <LogIn className="h-7 w-7" />
              </div>
              <CardTitle className="text-2xl font-bold">Login to Your Account</CardTitle>
              <CardDescription className="text-card-foreground/80"> {/* Adjusted opacity */}
            ...
            <CardContent>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input 
                            ...
                            className="text-base bg-input/80 focus:bg-input" // Adjusted input background
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
              ...
              <p className="mt-6 text-center text-sm text-card-foreground/80"> {/* Adjusted opacity */}
